...
export default function LoginPage({ onLoginSuccess }) {
  ...
  // Input focus & validation tracking
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      setError(err.response?.data?.detail || 'Google Authentication failed. Please try standard login.');
    } finally {
  ...
  return (
    ...
    >
      {/* Background Decorative Lighting & Ambient Gradients */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        {isDark ? (
          ...
          <>
            <div className="absolute top-0 left-1/3 w-[600px] h-[600px] bg-teal-500/10 rounded-full blur-[140px] pointer-events-none" />
            <div className="absolute bottom-0 right-1/3 w-[500px] h-[500px] bg-blue-500/10 rounded-full blur-[140px] pointer-events-none" />
            <div 
        ...
        <button
          ...
          className={`flex items-center gap-2 px-3.5 py-2 rounded-2xl text-xs font-semibold border transition-all duration-300 shadow-sm backdrop-blur-md ${
            isDark 
              ...
              : 'bg-white/80 border-slate-200 text-slate-700 hover:text-slate-900 hover:border-slate-300'
          }`}
        >
          {isDark ? (
            <>
      ...
      {/* Login Card */}
      <div className="relative w-full max-w-[450px] z-10 animate-in fade-in zoom-in-95 duration-300">
        <div className={`rounded-3xl p-8 sm:p-10 border shadow-2xl backdrop-blur-xl transition-all duration-300 ${
          isDark 
          ...
          <div className="flex flex-col items-center text-center mb-8">
            <div className="relative mb-4 group">
              <div className={`absolute -inset-1.5 rounded-3xl opacity-30 blur-md transition duration-500 ${
                isDark ? 'bg-teal-500/40' : 'bg-teal-600/30'
              }`} />
              <div className={`relative w-20 h-20 rounded-2xl border flex items-center justify-center p-2 shadow-xl overflow-hidden ${
                isDark ? 'bg-slate-950 border-slate-800' : 'bg-white border-slate-200'
              }`}>
                <img 
                  src="/logo.png" 
                  alt="E-Store Brand Logo" 
                ...
                />
                <div className="hidden w-full h-full items-center justify-center text-teal-500">
            ...
            <p className={`text-xs sm:text-sm mt-1 max-w-xs ${isDark ? 'text-slate-400' : 'text-slate-600'}`}>
          ...
          {/* Error Message */}
          {error && (
            <div className="mb-5 p-3.5 rounded-2xl bg-rose-500/10 border border-rose-500/30 text-rose-500 text-xs flex items-start gap-2.5 animate-in fade-in slide-in-from-top-2 duration-200">
          ...
          {/* CapsLock Warning */}
          {capsLockActive && (
            <div className="mb-4 p-2.5 rounded-xl bg-amber-500/10 border border-amber-500/30 text-amber-500 text-xs flex items-center gap-2">
          ...
          <button
            ...
            className={`w-full mb-5 py-2.5 px-4 rounded-2xl text-xs font-bold transition-all duration-200 flex items-center justify-center gap-3 border shadow-sm disabled:opacity-50 group ${
              isDark 
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="e.g. Sahan or sahanpramuditha91@gmail.com"
                  className={`
          ...
          <div className={`mt-8 pt-5 border-t flex items-center justify-center gap-2 text-[11px] font-mono ${
